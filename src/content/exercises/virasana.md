...
contraindications:
  ...
  - Meniscal injury
  - Knee pain on kneeling
  - Ankle injury that makes the foot position painful
stopIf:
  - Any pain inside the knee joint, as opposed to a stretch on the front of the thigh
...
most demanding position in this library. It is included with that stated plainly rather than
left out, because it is common in yoga classes and people with stiff knees meet it whether or
not a reference like this mentions it.

What it does mechanically is stretch the quadriceps with the hip extended — which, because
rectus femoris crosses both joints, reaches that muscle in a way seated stretches do not.

The height you sit on is the whole exercise. Sitting on enough support that the position is
easy gives you a quadriceps stretch. Sitting on the floor when your knees cannot fold that
far gives you a compressed joint. These are different activities that happen to look similar,
and the second one has no advantage over the first.

The chair modification is worth taking seriously rather than treating as a lesser option. It
reaches the same muscle with the knee bearing no load at all.
