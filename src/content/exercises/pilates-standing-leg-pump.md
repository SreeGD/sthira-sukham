...
exercises build capacity; this begins to connect it to the positions daily life demands.

The range is deliberately small. A shallow bend done with the knee tracking correctly is worth
more here than a deep one done with the knee drifting inward, because the point is to train
the pattern under load, not to reach a depth.

Pairing the knee bend with the heel raise covers both ends of the leg — quadriceps controlling
the knee, calf controlling the ankle — and those two together account for a large share of what
