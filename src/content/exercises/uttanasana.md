...
contraindications:
  ...
  - Dizziness on standing up from forward bends
stopIf:
...
in a way that stretches something else.

Straight legs with a rounded back move the demand from the hamstrings to the lower back and
the tissue around the spine. Bent knees with a long spine keep it where it was aimed. Since
the goal is hamstring length rather than fingertips-to-floor, the bent-knee version is
simply the better exercise, not the easier one.

The relevance to a knee is direct: hamstrings that will not lengthen resist the last part of
knee straightening, and a knee that never straightens fully never gets to rest on its own
locked position.
