...
that so much knee stiffness depends on.

Slowness is the active ingredient rather than a stylistic preference. Shift your weight
quickly and momentum carries you across; the stabilising muscles get a brief pulse of work.
Shift slowly and there is no momentum to borrow — gluteus medius has to control the pelvis
continuously through the entire transfer. That sustained demand is exactly what it is
supposed to do during walking and often stops doing.

It is also unusually well suited to a guarded, painful knee. There is no end-range stretch,
no impact, and the load is low and constant, which makes it available on days when more
demanding work is not.

A randomised trial comparing twelve weeks of tai chi with standard physical therapy in 204
people with knee osteoarthritis found both produced substantial improvement, with tai chi
performing comparably to physical therapy.
