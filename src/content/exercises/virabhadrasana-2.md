---
name: Warrior II
traditionalName: Virabhadrasana II
...
and hip control at the same time.

Two checks decide whether this helps a knee. The knee must track over the middle of the foot
and not fall inward, which is the hip's job rather than the knee's. And the knee should stay
roughly above or behind the ankle rather than travelling well past the toes, which loads the
kneecap joint disproportionately.

Both fail first, long before the thigh tires. Which means the honest depth for most people is
much shallower than the pose is usually taught, and shallower is not a lesser version of it.
