...
The detail that matters for knees specifically is the front knee. In a straight-legged
standing pose it is easy to push the joint past straight into hyperextension, particularly
for people whose knees already go that way. That takes the load off the hamstring and puts
it into the back of the joint, which is the opposite of the intent. Keeping a visible
softness in the knee costs nothing and changes where the stretch lands.

Reaching the floor is not an aim. A hand on a chair with a long spine does more than a hand
on the floor with a rounded one.
