...
dosage:
  reps: One full alphabet per side
...
visiting all of them without having to remember a list.

Its value is coverage rather than depth. Ordinary walking uses a narrow band of the available
range in one plane; drawing letters takes the joint through combinations of up, down, in and out
that nothing in a normal day requires.

The one rule is that the shin stays still. It is easy to make larger letters by swinging the
whole leg, and doing so removes the ankle from the exercise entirely.
