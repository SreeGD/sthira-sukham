---
name: Side kick front and back
traditionalName: Side Kick Series
...
harder request than it sounds, and the whole reason the exercise exists.

The forward swing asks the hip flexors to shorten and the glutes to lengthen; the backward
swing asks the reverse. Doing both without the pelvis rocking trains the hip to move
independently of the spine, and a hip that does not borrow from the spine is a hip that
also does not borrow from the knee.

Most people's honest range here is a fraction of what they first attempt. Shorten it until
the torso genuinely stays still, then work from there.
