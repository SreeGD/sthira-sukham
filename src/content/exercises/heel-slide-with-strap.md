...
The reason to add the strap is that the last few degrees of bending are the ones your own
muscles are least able to produce — particularly when those muscles are the ones being
stretched. An external pull can take the joint slightly further than it can take itself.

That is also exactly why it needs more caution than the unassisted version. Your hamstrings
pulling the knee into a bend will stop when it hurts. A strap will not.
