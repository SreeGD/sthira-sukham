...
Pilates approach: the load is deliberately low so that control becomes the limiting factor
rather than strength.

What is being trained is the ability to move the leg at the hip without the pelvis coming
along for the ride. That separation is what the hip flexor should do and frequently stops
doing — the leg moves, the pelvis tips, and the lower back absorbs the difference.

Its relevance to the knee is upstream. A hip that moves independently of the pelvis puts the
thigh where it should be, and the knee sitting on the end of a well-positioned thigh has less
to compensate for. Range of motion is not the goal here; the quality of a small movement is.
