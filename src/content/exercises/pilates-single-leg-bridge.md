...
traditionalName: Single Leg Shoulder Bridge
...
contraindications:
  ...
  - Acute low back pain
  - Hamstring cramping that does not settle in the two-footed bridge
stopIf:
...
What is being trained is not really the lift — it is the refusal to drop. The moment one
foot leaves the floor, the muscles on the standing side have to hold the pelvis level
against the weight of the other half of the body. That is gluteus medius' actual job
description.

Watch for the pelvis dropping rather than the leg rising. A small lift with the hips level
is the exercise; a big lift with the pelvis tilting is a different, easier movement wearing
the same name.
