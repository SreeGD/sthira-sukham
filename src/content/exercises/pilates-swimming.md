...
to work in and one that sitting takes away entirely.

The reason to keep the lift small is that the range beyond a couple of inches does not come
from the hip. It comes from the lower back arching, which is easy to do, feels like more,
and trains the wrong thing.

For a stiff knee the connection is the familiar one: a gluteus maximus that extends the hip
is a gluteus maximus that is not leaving the job to the hamstrings, and hamstrings kept
permanently busy resist the knee straightening fully.
