...
best explains why a knee reference talks so much about the hip.

Two details determine whether you get the muscle you came for. Keep the toes pointing forward
rather than rotating up toward the ceiling — turning out hands the work to the hip flexors and
tensor fasciae latae, which is the compensation pattern you are trying to undo. And keep the
top hip stacked; rolling backward brings in the same substitutes.

Done accurately, the range is small and it burns quickly. Done inaccurately, it is easy and
achieves nothing. If it feels easy, check the two details above before adding repetitions.
