...
in what it removes rather than what it adds.

Lying down with the heel supported means the quadriceps does not have to hold the weight of
the leg against gravity. The joint gets taken through its bending range without the muscles
around it having to work, which matters when those muscles are guarding or inhibited — the
two states in which they most interfere with the movement you are trying to recover.

Sliding back out to straight under control matters as much as the bend. That return is the
part people rush, and it is where the extension end of the range gets its work.
