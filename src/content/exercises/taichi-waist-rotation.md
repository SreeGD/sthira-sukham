---
name: Waist and hip rotation
traditionalName: Zhuan Yao (turning the waist)
...
The safety point here is worth stating plainly, because this movement is sometimes taught
badly. The knee is a hinge with a small amount of rotation available, and almost none when
it is straight and weight-bearing. Turning your body with the feet planted and the knees
locked means the rotation has to come from the knee joint itself, which is not where it
should come from. Letting the knees turn with the hips keeps the rotation at the hip and the
ankle, where there is range to spare.

Done that way it is a gentle way to visit hip rotation, which is the movement gluteus medius
and the adductors control and the one that determines what the knee is sitting on top of.
