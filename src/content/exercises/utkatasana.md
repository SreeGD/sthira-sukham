...
about strength rather than range.

"Sit back, not down" is the instruction that decides whether this helps or irritates. Hips
travelling backward loads the thigh and the buttock; knees travelling forward over the toes
loads the kneecap joint. The check of still being able to see your toes past your knees is
a crude but reliable way to tell which one you are doing.

The wall version is worth using rather than treating as a fallback: it fixes the depth,
removes the balance element, and lets you attend to where the knees are pointing.
